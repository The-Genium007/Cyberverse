...
RED4ext::v1::PluginHandle PLUGIN = nullptr;
...
RED4EXT_C_EXPORT void RED4EXT_CALL Query(RED4ext::v1::PluginInfo* aInfo)
{
     ...
     *
     * Runtime version is the game's version, it is best to let it set to "RED4EXT_V1_RUNTIME_VERSION_INDEPENDENT" if you want to target
